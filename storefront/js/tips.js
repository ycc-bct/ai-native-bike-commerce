...
(function () {
  ...
  var TABS = [
    ...
    {id: 'ride',    t: '線上騎乘體驗', page: 'scenario-2/', items: [
      {key: 'ride-pick', h: '選一段風景 → 挑車出發', d: '從城市通勤、公路旅遊、山路挑戰選一段路，拖拉五軸或直接打字說需求，AI 會重新排列車款，選好按「騎乘體驗」出發。'},
      {key: 'ride-go',   h: '騎到岔路 → 自己選路', d: '影片騎到路口會停在岔路畫面，選「碎石路」繼續騎（連續陡坡目前僅供預覽）；騎完 AI 把路段、車款與時間整理成騎乘報告。'},
      {key: 'ride-ai',   h: '騎乘中問 AI → 換一台試試', d: '騎到一半點右上角的顧問，選你在意的車身穩定、減少震動或更省力，它會推薦同情境的車款，可以直接換車繼續騎。'}
    ]},
